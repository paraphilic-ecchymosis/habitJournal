...
public class Config {
    ...
    /**
     * Prints the date, UID, behavior key and unit completed of users from
     * spreadsheet:
     * https://docs.google.com/spreadsheets/d/1SrCbIbgXSCtM2jz2x1qC7dmiVjVQVf1M_fWpuBIs_hc/edit
     */
    // public static void getJournal() throws IOException, GeneralSecurityException {
    //     // Build a new authorized API client service.
    //     final NetHttpTransport HTTP_TRANSPORT = GoogleNetHttpTransport.newTrustedTransport();
    //     final String range = "journal!A3:D";
